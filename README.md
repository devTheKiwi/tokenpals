...
핀 가능한 작은 윈도우 안에 디바이스마다 캐릭터(감자형) 한 마리가 살아 움직임.
상태에 따라 위치/행동이 변함:
...
[ClaudePet](https://github.com/devTheKiwi/ClaudePet)(데스크톱 위 떠다니는 펫)과 영역이 다르고 의미가 보완적이라 **공존 가능**.
